...
void llvm::combineMetadata(Instruction *K, const Instruction *J,
  ...
  // TODO(victory): Eventually re-implement Swarm metadata more consistently
  // with standard LLVM metadata like invariant.load and invariant.group.
  bool SwarmClosure =
      K->getMetadata(SwarmFlag::Closure) && J->getMetadata(SwarmFlag::Closure);
  ...
  if (SwarmClosure)
    K->setMetadata(SwarmFlag::Closure, MDNode::get(K->getContext(), {}));
}
