...
void SelectionDAGBuilder::visitSDetach(const SDetachInst &I) {
  // Lowering of Tapir instructions should have happened already.
  llvm_unreachable("Unable to generate assembly for unlowered sdetach");
}

void SelectionDAGBuilder::visitSReattach(const SReattachInst &I) {
  // Lowering of Tapir instructions should have happened already.
  llvm_unreachable("Unable to generate assembly for unlowered sreattach");
}
...
SelectionDAGBuilder::visitIntrinsicCall(const CallInst &I, unsigned Intrinsic) {
  ...
  case Intrinsic::syncregion_start:
    return nullptr;
  // Swarm intrinsics
  case Intrinsic::deepen:
  case Intrinsic::undeepen:
    llvm_unreachable("Deepen/undeepen intrinsics not lowered?");
  }
}
