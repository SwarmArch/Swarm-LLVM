...
AliasResult ScopedNoAliasAAResult::alias(const MemoryLocation &LocA,
  ...
  // SwarmMemArgs never alias with other memory operations
  if (isSwarmMemArgs(ANoAlias) || isSwarmMemArgs(BNoAlias))
    return NoAlias;
...
ModRefInfo ScopedNoAliasAAResult::getModRefInfo(ImmutableCallSite CS,
  ...
  // SwarmMemArgs alias with callsites tagged ForceAlias, o/w never alias
  if (isSwarmMemArgs(Loc.AATags.NoAlias))
    return isSwarmMemArgsForceAlias(
