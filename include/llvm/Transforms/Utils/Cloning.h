...
/// \p LoopDomBB.  Inserts the new blocks before block specified in \p Before.
///
/// If \p LoopParent is given, the cloned loop is made LoopParent's child.
/// Otherwise, the cloned loop inherits OrigLoop's parent.
///
