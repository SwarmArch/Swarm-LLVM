...
public:
  ...
  ///    0 = -P0 = leave with detach instructions,
  //     1 = no optimizations before conversion,
  //     2 = optimize before conversion
  //     3 = ??? TODO(mcj) this is -fdetach?
  //     4 = optimize before conversion and permit speculative parallelization
