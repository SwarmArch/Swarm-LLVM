...
/// Initialize all passes linked into the SwarmOpts library.
void initializeSwarmOpts(PassRegistry&);
...
void initializeBundlingPass(PassRegistry&);
...
void initializeCreateParallelizableCopyPass(PassRegistry&);
...
void initializeFractalizationPass(PassRegistry&);
...
void initializeInsertHeartbeatsPass(PassRegistry&);
...
void initializeLoopCoarsenPass(PassRegistry&);
void initializeLoopDataPrefetchLegacyPassPass(PassRegistry&);
void initializeLoopDeletionLegacyPassPass(PassRegistry&);
void initializeLoopDistributeLegacyPass(PassRegistry&);
void initializeLoopExpansionPass(PassRegistry&);
...
void initializeLowerTapirToSwarmPass(PassRegistry&);
...
void initializeProfitabilityPass(PassRegistry&);
...
void initializeSpatialHintsPass(PassRegistry&);
