...
namespace {
  struct ForcePassLinking {
    ForcePassLinking() {
      ...
      (void) llvm::createCreateParallelizableCopyPass();
      ...
      (void) llvm::createFractalizationPass();
      ...
      (void) llvm::createInsertHeartbeatsPass();
      ...
      (void) llvm::createLoopCoarsenPass();
      (void) llvm::createLoopExpansionPass();
      ...
      (void) llvm::createLowerTapirToSwarmPass();
      ...
      (void) llvm::createSpatialHintsPass();
      ...
      (void) llvm::createProfitabilityPass();
